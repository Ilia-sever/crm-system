...
<div class="form-group">
    ...
    <div class="radio">
        <label>
            <input type="radio" name="assignment-control" class="assignment__radio assignment__radio_workarea" 
            @if ($data['object']['workarea_id']) checked @endif/>{{trans('strings.fields-name.workarea')}}</label>
    </div>
    <div class="radio">
        <label>
            <input type="radio" name="assignment-control" class="assignment__radio assignment__radio_stage" @if ($data['object']['stage_id']) checked @endif/>{{trans('strings.fields-name.stage')}}</label>
    </div>
