...
class DocumentsController extends ModuleController
{
    ...
    /**
    * Form data for page opening
    *
    * Отправляет документ на скачивание
    *
    * @return resource
    */
    ...
    * Form data for page opening
    *
    * Формирует панель выбора документа
    *
    * @return object
    */
    ...
    * Form data for page opening
    *
    * Возвращает на основании параметров запроса список объектов-документов для панели выбора документа  
    *
    * @return object
    */
