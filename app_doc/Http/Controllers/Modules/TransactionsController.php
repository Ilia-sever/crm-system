...
/**
* Transactions module controller
*
* Контроллер модуля "Транзакции"
*
...
class TransactionsController extends ModuleController
{
    ...
    *
    * Формирует страницу настройки типов транзакций
    *
    * @return object
    */
    ...
    * Form data for page opening
    *
    * Обрабатывает запрос на изменение типов транзакций
    *
    * @return object
    */
