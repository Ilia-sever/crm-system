...
/**
* Notifications objects model
*
* Модель объектов уведомлений
*
...
class Notification extends MainModel
{
	...
	/**
    * Gets the specified number of recent employee notifications
    *
    * Получает заданное число последних уведомлений сотрудника
    *
    ...
    */
    ...
    /**
    * Save notification's data
    *
    * Сохраняет данные уведомления
    *
